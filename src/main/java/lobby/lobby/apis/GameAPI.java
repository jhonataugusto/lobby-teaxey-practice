...
//	    double threshold = 1.0D;
	...
	public static Player getRandomPlayer(List<Player> list){
		return list.get(lobby.lobby.apis.ExtraAPI.getRandomInt(1, list.size())-1);
	}
	...
	public static List<Player> getPlayers() {
		return lobby.lobby.apis.RexAPI.getPlayers();
	}
	...
	public static void makeInvunerable(Player player) {
		player.setNoDamageTicks(lobby.lobby.apis.ObjectAPI.DAY_IN_SECONDS * 20);
	...
	public static void changeTabName(Player player, String displayName) {
		player.setPlayerListName(lobby.lobby.apis.ExtraAPI.toText(displayName));
	}
	...
	public static void resetScoreboard(Player player) {
		player.setScoreboard(lobby.lobby.apis.ExtraAPI.getMainScoreboard());
	}
	// Parei aqui
	...
	public static boolean isFalling(Entity entity) {
		return entity.getVelocity().getY() < lobby.lobby.apis.ObjectAPI.WALKING_VELOCITY;
	}
